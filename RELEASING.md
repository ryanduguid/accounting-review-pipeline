...
```bash
gh release download v0.1.1 -R ryanduguid/monthly-close-controls --dir release-v0.1.1
cd release-v0.1.1
sha256sum --check SHA256SUMS
gh attestation verify monthly_close_control_plane-0.1.1-py3-none-any.whl -R ryanduguid/monthly-close-controls
gh attestation verify monthly_close_control_plane-0.1.1-py3-none-any.whl -R ryanduguid/monthly-close-controls --predicate-type https://spdx.dev/Document/v2.3
gh release view v0.1.1 -R ryanduguid/monthly-close-controls --json isImmutable
gh release verify v0.1.1 -R ryanduguid/monthly-close-controls
gh release verify-asset v0.1.1 monthly_close_control_plane-0.1.1-py3-none-any.whl -R ryanduguid/monthly-close-controls
```
