...
3. **National Business Day Calendar**: A business day excludes Saturdays, Sundays, and any public holiday for the **whole of any State or Territory**. The ATO's [Payment deadlines for Payday Super](https://www.ato.gov.au/businesses-and-organisations/super-for-employers/paying-super-on-payday/payment-deadlines-for-payday-super) page says a public holiday that applies to only part of a state or territory is still a business day. That covers regional show days, such as the Royal Queensland Show and the Tasmanian show and regatta days, and holidays that named local areas may replace with another day, such as the WA King's Birthday and Melbourne Cup Day; none of them stops the national clock. The synthetic fixtures use a reduced calendar, as listed in `tools/generate_fixtures.py`: the eight nationwide holidays, NT Picnic Day (3 August 2026), Victoria's Friday before the AFL Grand Final (25 September 2026) and the Queensland King's Birthday (5 October 2026), which is also Labour Day in NSW, South Australia and the ACT. Each date is cited to its own government source in that file. The part-day evening holidays South Australia and Queensland observe on 24 and 31 December are still missing. A whole-of-state holiday missing from the list makes a sample due date earlier than the rule requires, never later.
