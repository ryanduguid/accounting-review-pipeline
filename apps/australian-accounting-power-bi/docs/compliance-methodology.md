...
3. **National Business Day Calendar**: A business day excludes Saturdays, Sundays, and any public holiday gazetted for the **whole of any State or Territory**. Holidays gazetted for part of a state (for example the Royal Queensland Show, which is Brisbane only, and the Tasmanian show and regatta days) do not stop the national clock. A holiday that covers a whole state while letting named local areas substitute another day, such as the WA King's Birthday and Melbourne Cup Day, does. The synthetic fixtures use a reduced calendar, as listed in `tools/generate_fixtures.py`: the eight nationwide holidays, NT Picnic Day (3 August 2026), the WA King's Birthday (28 September 2026) and the Queensland King's Birthday (5 October 2026), which is also Labour Day in NSW, South Australia and the ACT. Each date is cited to its own government source in that file. Two whole-of-Victoria holidays in the same window are still missing, the Friday before the AFL Grand Final (25 September 2026) and Melbourne Cup Day (3 November 2026), as are the part-day evening holidays South Australia and Queensland observe on 24 and 31 December. A whole-of-state holiday missing from the list makes a sample due date earlier than the rule requires, never later.
